        ...
        <div class="row justify-content-center">
            <div class="col-md-12">
                <div class="card" style="margin: 10%;">
                    <div class="card-header bg-success text-white"><h5>Edit Situs</h5></div>
                    <div class="card-body">
                        <form action="{{route('setting.update',$setting->id)}}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="aplikasi" value="{{$setting->aplikasi}}" class="form-control @error('aplikasi') is-invalid @enderror">
                                @error('aplikasi')
