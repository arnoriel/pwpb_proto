...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body class="antialiased">
        ...
        <nav class="navbar navbar-expand-sm navbar-dark fixed-top" style="background-color: #0E1D35">
          ...
          <p style="width: 30rem;"><strong>Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.</strong></p>
          <a href="/book" class="btn btn-outline-dark">Lihat Buku</a>
              </div>
          <div class="col-sm-3">
            <img src="{{asset('img/welcome.png')}}" style="width: 500px;">
            </div>
            </div>
